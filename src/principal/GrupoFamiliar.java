...
public class GrupoFamiliar extends Persona{
    ...
    public GrupoFamiliar(Afiliados afiliado, String Nombre, String Apellido, String Direccion, String Fechadenacimiento, int Documento, String Telefono, String DireccionCorreo) {
