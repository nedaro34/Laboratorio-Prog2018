 ...
 */
public class jChofer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Ingresar Chofer");
        ...
        jButton5.setText("Mostrar Chofer");
        ...
        jPanel1.add(jPanel_Caja, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 890, 440));
  ...
  int posicion = this.jPanelMenu.getX();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        new CambiaPanel(jPanel_Caja,new Mostrar_Choferes());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jChofer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
