 ...
 */
public class jGrupoFamiliar extends javax.swing.JFrame {

    /**
     * Creates new form inicio
     */
    public jGrupoFamiliar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jGrupoFamiliar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jGrupoFamiliar().setVisible(true);
            }
        });
    }
