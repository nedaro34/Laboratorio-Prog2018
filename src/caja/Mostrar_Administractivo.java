 ...
 * @author TAPIA
 */
public class Mostrar_Administractivo extends javax.swing.JPanel {
    LinkedList<Administrativos>listar = new LinkedList<Administrativos>();
    /**
     * Creates new form Mostrar_Afiliados
     */
    public Mostrar_Administractivo() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            listar = centro.MostrarAdministrativo();
        } catch (ListaVaciaExcepcion ex) {
            Logger.getLogger(Mostrar_Administractivo.class.getName()).log(Level.SEVERE, null, ex);
        }
